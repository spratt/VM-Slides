...
\begin{frame}{Progress: high-level}
  \begin{columns}[T]
    \begin{column}{0.2\textwidth}
    \end{column}
    \begin{column}{0.6\textwidth}
...
\begin{frame}{Differences}
  \begin{columns}[T]
    ...
    \begin{column}{0.6\textwidth}
      ...
      \bi
    \item What happens when the kernel runs out of memory
    \item How the kernel accesses user memory
    \item Copy-on-write mechanisms
      \ei
    \end{column}
    \begin{column}{0.2\textwidth}
    \end{column}
...
\begin{frame}{How the kernel accesses user memory}
  \begin{columns}[T]
    \begin{column}{0.3\textwidth}
      Linux:
      \bi
...
\begin{frame}{Copy-on-write mechanisms}
  \begin{columns}[T]
    \begin{column}{0.3\textwidth}
      Linux:
      \bi
